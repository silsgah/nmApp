...
export default function StudentSettingsPage() {
  ...
  return (
    <div className="p-6 lg:p-8 max-w-2xl mx-auto space-y-6">
      {/* Header */}
      <div>
        <h1 className="page-title text-xl font-bold tracking-tight">My Profile & Settings</h1>
        <p className="page-subtitle text-xs text-muted-foreground mt-0.5">Manage your personal credentials and profile photograph</p>
      </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 p-4 rounded-xl border border-border/50 bg-muted/20">
            ...
            <div className="space-y-2 flex-1 text-center sm:text-left">
              ...
              <p className="text-[10px] text-muted-foreground/70">
                {uploading ? "Uploading photo..." : "Images are securely stored and verified against official candidate records."}
              </p>
            </div>
          </div>
        </CardContent>
